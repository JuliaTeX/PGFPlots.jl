...
export Plot, Bar, Circle, Command, Contour, Ellipse, Histogram, Histogram2, Image, Linear, Linear3, Node, Patch2D, Quiver, Scatter
...
type Bar <: Plot
    bar_heights::AbstractVector{Real}
    style
    Bar{A<:Real}(bar_heights::AbstractVector{A}; style=nothing) = new(bar_heights, style)
end
